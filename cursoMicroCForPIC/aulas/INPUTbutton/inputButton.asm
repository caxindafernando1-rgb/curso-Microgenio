...
L_main0:
;inputButton.c,16 :: 		if((BUTTON(&PORTB, 1, 50, 0))  && (estabilizadPortB1 == 0)){  // Bibilioteca para ler o botão se o botao(na porta b, no pino 0, depoi de 50 ms, tiver o valor 0)
	MOVLW      PORTB+0
	...
	GOTO       L_main5
L__main18:
;inputButton.c,17 :: 		estabilizadPortB1 = 1;
	BSF        main_estabilizadPortB1_L0+0, BitPos(main_estabilizadPortB1_L0+0)
;inputButton.c,18 :: 		}
L_main5:
;inputButton.c,21 :: 		if((BUTTON(&PORTB, 0, 50, 1)) && (estabilizadPortB0 == 0)){ // Bibilioteca para ler o botão se o botao(na porta b, no pino 0, depoi de 50 ms, tiver o valor 1)
	MOVLW      PORTB+0
	MOVWF      FARG_Button_port+0
	...
	GOTO       L_main8
L__main17:
;inputButton.c,22 :: 		estabilizadPortB0 = 1;
	BSF        main_estabilizadPortB0_L0+0, BitPos(main_estabilizadPortB0_L0+0)
;inputButton.c,23 :: 		}
L_main8:
;inputButton.c,26 :: 		if((!BUTTON(&PORTB, 0, 50, 1))  && (estabilizadPortB0 == 1)) {
	MOVLW      PORTB+0
	MOVWF      FARG_Button_port+0
	CLRF       FARG_Button_pin+0
	MOVLW      50
	...
	GOTO       L_main11
L__main16:
;inputButton.c,27 :: 		PORTD.F7 = ~PORTD.F7;
	MOVLW      128
	XORWF      PORTD+0, 1
...
;inputButton.c,29 :: 		}
L_main11:
;inputButton.c,31 :: 		if((!BUTTON(&PORTB, 1, 50, 0))  && (estabilizadPortB1 == 1)) {
	MOVLW      PORTB+0
	MOVWF      FARG_Button_port+0
	MOVLW      1
	MOVWF      FARG_Button_pin+0
	...
	GOTO       L_main14
L__main15:
;inputButton.c,32 :: 		PORTD.F6 = ~PORTD.F6;
	MOVLW      64
	XORWF      PORTD+0, 1
;inputButton.c,33 :: 		estabilizadPortB1 = 0;
